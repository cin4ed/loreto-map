        ...
        <div className="mt-4 space-y-5">
          ...
          <div className="border rounded-lg p-2 bg-zinc-50">
            ...
            <h3 className="font-bold text-sm mt-2">
              ¿Qué se puede construir aquí?
            </h3>
            <div className="text-sm">
              <p className="p-2">
                En una zona habitacional plurifamiliar, se pueden construir
                estructuras diseñadas para albergar a varias familias en
                unidades de vivienda separadas. Esto incluye, pero no se limita
                a:
              </p>
              <ul className="space-y-2 pl-4">
                <li className="space-y-1">
                  <h4>
                    <strong>Edificios de apartamentos:</strong>
                  </h4>
                  <p className="pl-2">
                    Estructuras de varios pisos con múltiples unidades
                    habitacionales, cada una con sus propias instalaciones de
                ...
                <li className="space-y-1">
                  ...
                  <p className="pl-2">
                    Unidades de vivienda individuales dentro de un complejo más
                    grande, donde los propietarios poseen su unidad específica y
                    comparten áreas comunes y servicios con otros propietarios.
                  </p>
                </li>
                <li className="space-y-1">
                  <h4>
                    <strong>Dúplex o triplex:</strong>
                  </h4>
                  <p className="pl-2">
                    Edificaciones que contienen dos o tres unidades de vivienda
                    independientes, respectivamente, a menudo con entradas
                    separadas para cada unidad.
                  </p>
                </li>
                <li className="space-y-1">
                  <h4>
                    <strong>Casas adosadas:</strong>
                  </h4>
                  <p className="pl-2">
                    Viviendas unifamiliares que comparten una o más paredes con
                    otras casas adosadas, pero tienen entradas independientes y
                    suelen tener varios pisos.
                  </p>
                </li>
                <li className="space-y-1">
                  <h4>
                    <strong>Viviendas multifamiliares de baja densidad:</strong>
                  </h4>
                  <p className="pl-2">
                    Pequeños edificios de apartamentos o complejos de casas
                    adosadas que ofrecen un ambiente más íntimo y menos unidades
                    por área, favoreciendo la privacidad y el espacio.
                  </p>
                </li>
              </ul>
              <p className="mt-4">
                Cada uno de estos tipos de construcción está diseñado para
                optimizar el uso del espacio y proporcionar viviendas cómodas y
                funcionales para múltiples familias, promoviendo así una
                comunidad densa y eficiente.
              </p>
            </div>
          </div>
        </div>
